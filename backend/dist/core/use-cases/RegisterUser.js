...
export class RegisterUser {
    ...
    async execute(username, passwordPlain, firstName, lastName, email, faceDescriptor, role = 'user') {
        ...
        for (const existing of existingDescriptors) {
            ...
            if (isSimilar) {
                ...
                throw new Error(`Este rostro ya está registrado para el usuario: ${existing.username}. ` +
